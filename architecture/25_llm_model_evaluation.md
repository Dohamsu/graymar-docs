...
### J-7. Solar 전용 프로파일 실런 (2026-09-03) — arch/113 참조

브랜치 `feat/solar-dialogue-profile` 로 라벨 재강조 프로파일 + 화자 연속 귀속을 구현해 실런 15턴 ×2 재측정: 원문 라벨 70→82% ·
어체 위반 16.7→8.1% · 무라벨 잔존 3→0 · 지연 1.32배(조건 ③ 근접 미달) · 게이트 15/15. 상세와 판정은 arch/113 §4.
