...
- [[architecture/02_combat_system|combat system]] — 전투 공식 · 흐름
- [[specs/combat_engine_resolve_v1|combat engine resolve v1]] — resolveCombatTurn 구현
- [[specs/input_processing_pipeline_v1|input processing pipeline v1]] — IntentParser 구조
- [[CLAUDE]] Invariant 1/2/4/6/18 — 불변식 준수 포인트
