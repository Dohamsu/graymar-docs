...
| 112_location_turn_service_split.md | ✅ Phase 0~2 + P3-A 완료 | turns.service 3차 재비대(7,975/7,900·함수 2,047/2,000) 대응 — LOCATION 파이프라인을 location-turn(5,171)으로 이관 + location-quest(1,108)·location-result(1,289) 분리, 오케스트레이터 1,620줄. 래칫 상한 불변·lint 경고 0·동작 보존 기계 대조. Phase 3(LocationTurnContext·UI 부착 타입화·배선 정합 스펙)은 트리거 명시 후속 |
