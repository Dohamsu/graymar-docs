...
├── architecture/        ← 통합 아키텍처 문서 (56 md + INDEX.md 색인, 실무 참조, archive 4 md)
...
### architecture/ — 통합 아키텍처 (56 md + INDEX)
...
| 69_npc_living_presence.md | ⚠️ 부분 | NPC Living Presence B축 — B0~B4 ✅ 구현·통합 검증(정보 편향 88→40%, 근황 발화, 목격 버그 수정) + 어미 다양화 26명 재배정. 어체 검증 C안: **C1(레거시 치환 제거)·C2(화자 인지 어체 계측+검증기 버그 3건 수정) ✅ 완료**, C3 정밀 베이스라인 확정(3세션: HAPSYO 52% 하오체 이탈, HAOCHE 3.9% 안정) — HAPSYO 단독 재생성 파일럿 착수 대기 (2026-07-13) |
