...
| 69_npc_living_presence.md | ⚠️ 부분 | NPC Living Presence B축 — B0~B4 ✅ 구현·통합 검증(정보 편향 88→40%, 근황 발화, 목격 버그 수정) + 어미 다양화 26명 재배정. 어체 검증 C안: **C1(하오체 강제 레거시 치환 제거) ✅ 완료**, C2 화자 인지 계측·C3 조건부 선별 재생성 착수 대기 (2026-07-13) |
