...
├── architecture/        ← 통합 아키텍처 문서 (35 md, 실무 참조)
...
| 34_player_first_event_engine.md | ✅ 구현됨 | Player-First 이벤트 엔진 (TurnMode 3분류, NPC 우선순위 역전, contextNpcId) |
| 35_llm_streaming_design.md | ✅ 구현됨 | LLM 스트리밍 (SSE 실시간 토큰, StreamParser, 2-Phase 렌더링, 폴링 fallback) |
