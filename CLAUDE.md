...
├── architecture/        ← 통합 아키텍처 문서 (65 md + INDEX.md 색인, 실무 참조, archive 4 md)
...
### architecture/ — 통합 아키텍처 (65 md + INDEX)
...
| 78_narrative_opener_pronoun_cycle.md | ✅ 수용 종결 | 개시어·대명사 편중 억제 — D5 센서 + 임계 3→2 + 대명사 12종 1키 합산. 20.3%→16.2%(-20.2%, soft 지시 천장 — 소유자 수용). 즉흥 별칭 가설 실측 기각. 2차 처방은 백로그 (2026-07-18) |
| 79_prompt_token_optimization.md | 📐 계획 | 측정 기반 스테이지별 프롬프트 예산 — P0 실측(narrative 10.9k=예산 4.3배·재시도 16.5%·intent 3.9k) 완료, P1 준수율 상관→P2 예산 고정→P3 최적화(전 블록 예산·intent A/B·캐싱)→P4 게이트 (2026-07-18) |
