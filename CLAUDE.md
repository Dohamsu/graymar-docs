...
| 69_npc_living_presence.md | ✅ 구현됨 | NPC Living Presence B축 — B0 계측(정보 편향 88% 실측)·B1 반응 자기목적(INFO 88→40%)·B2 잡담 활동 결합·B3 재등장 연속성·B4 NPC 간 근황 발화(selectRelationMentionCore)+목격 파이프 버그 수정. A축(선제 단서 억제)은 arch/68 부록 M (2026-07-13) |
