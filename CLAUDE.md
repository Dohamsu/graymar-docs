...
├── architecture/        ← 통합 아키텍처 문서 (31 md + INDEX.md 색인, 실무 참조)
...
| turns/ | 1 | 턴 제출/조회 |
| llm/ | 19 | Worker, ContextBuilder, TokenBudget, Prompt, NpcDialogueMarker, NanoDirector, NanoEventDirector, NpcReactionDirector, ChallengeClassifier, DialogueGenerator, LlmStreamBroker, StreamClassifier, FactExtractor, Lorebook, MemoryRenderer 외 |
...
### architecture/ — 통합 아키텍처 (31 md + INDEX)
