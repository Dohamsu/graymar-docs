...
├── architecture/        ← 통합 아키텍처 문서 (46 md + INDEX.md 색인, 실무 참조, archive 4 md)
...
### architecture/ — 통합 아키텍처 (46 md + INDEX)
...
| 55_npa_metric_v2.md | ✅ 구현됨 | NPA 메트릭 v2 — 다중 NPC 정확 측정 (utterance 단위 자기 register/호칭 평가) (2026-04-29) |
