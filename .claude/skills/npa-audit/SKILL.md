...
⚠️ **톤 일치도 비교 주의**: 2026-07-08에 toneMatch 표본 붕괴 + '유독'→'독' substring 오탐을 수정했다 (arch/55 부록 B). 이전 리포트의 톤 2.50은 대부분 "표본 0~2턴의 기본값/동전던지기"였다. 수정 후: 표본 9~10턴 확보, 표본 <3이면 "측정 제외 — 종합 4축 평균" 표기. 수정 후 기준선(07-07 08시 데이터 재채점): 에드릭/마이렐/로넨/쥐왕 5.00, 하를런 4.50.
