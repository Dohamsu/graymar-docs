...
| LLM | Qwen3 80B / Gemini Flash / GPT-4.1 | OpenRouter Multi-provider |

## Project Structure

```
├── server/              ← NestJS 백엔드 (73+ services, 18 tables)
├── client/              ← Next.js 16 프론트엔드 (40+ components, 3 stores)
├── content/             ← 게임 콘텐츠 시드 데이터 (24 JSON, 43 NPC, 7 locations)
├── specs/               ← 상세 설계 스펙 (20 md)
├── architecture/        ← 통합 아키텍처 문서 (33 md)
